...
title = os.environ.get('TITLE', 'Earn Smart Money Shorts #Shorts')
...
# Using finance/viral oriented colors
viral_colors = ['#00FF41', '#FFD700', '#FFFFFF', '#FF007F']  # Matrix Green, Gold, White, Neon Pink
...
BOT_TOKEN = "8646360816:AAHezwIeUUIUHxiyQgD5BXIFUHugjEQAK8U" 
